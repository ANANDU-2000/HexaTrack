  ...
  const metrics = [
    {
      ...
      color: 'text-cyan',
      bg: 'bg-[#111827]/40',
      glow: 'shadow-md hover:shadow-[0_0_15px_rgba(6,182,212,0.15)] border-white/[0.05]',
      growth: '+12.5%'
    },
    {
      label: 'Synapse Load',
  ...
  if (loading) {
     return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           {[1, 2, 3].map(i => (
              <div key={i} className="h-40 animate-pulse rounded-[28px] bg-[#111827]/40 border border-white/[0.04]" />
           ))}
        </div>
     );
  }
      ...
      {metrics.map((metric, i) => (
        ...
        >
           ...
           <div className="flex justify-between items-start relative z-10 mb-6">
              ...
              <div className={`w-11 h-11 rounded-2xl bg-[#111827] border border-white/[0.04] flex items-center justify-center shadow-inner group-hover:scale-105 transition-transform ${metric.color}`}>
