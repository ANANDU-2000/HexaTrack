...
export function SavingsCard() {
  ...
  return (
    <section className="mt-6">
      <div className="bg-[#111827] border border-white/[0.04] rounded-[32px] p-6 overflow-hidden relative flex flex-col sm:flex-row gap-6 items-center hover:border-white/[0.08] transition-colors">
        ...
        <div className="relative w-32 h-32 shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-[#F9FAFB]">
            <span className="text-xl font-bold">{percentage}%</span>
            <span className="text-[10px] text-[#9CA3AF] font-semibold uppercase tracking-wide">Saved</span>
          </div>
        </div>
        ...
        <div className="flex-1 w-full text-center sm:text-left">
          <div className="flex items-center justify-center sm:justify-start gap-2 mb-1">
            ...
            <h3 className="text-base font-bold text-[#F9FAFB]">Savings & Goals</h3>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#1A2333] p-3 rounded-2xl border border-white/[0.03]">
              <p className="text-[10px] text-[#9CA3AF] font-bold uppercase tracking-wider mb-0.5">Target</p>
              <p className="text-base font-bold text-[#F9FAFB]">{money(savingsGoal)}</p>
            </div>
            <div className="bg-[#1A2333] p-3 rounded-2xl border border-white/[0.03]">
              <p className="text-[10px] text-[#9CA3AF] font-bold uppercase tracking-wider mb-0.5">Remaining</p>
