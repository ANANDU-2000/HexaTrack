        ...
        {showMenu && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 bg-[#050816]/75 backdrop-blur-md z-[80]"
            />
            ...
            <motion.div
              ...
              className="fixed bottom-24 right-6 md:bottom-28 md:right-8 z-[85] w-72 bg-[#0E152B]/85 backdrop-blur-xl border border-white/[0.08] rounded-[28px] p-5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden"
            >
