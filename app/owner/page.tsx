...
import { 
  ...
  PieChart, RefreshCcw, DollarSign, Wallet, Plus, ShieldAlert
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0B1015] text-white flex font-sans selection:bg-[#4F8CFF]/30">
      ...
      <aside className="w-[280px] border-r border-white/[0.05] bg-[#0B1015] hidden xl:flex flex-col sticky top-0 h-screen">
        ...
        <div className="flex-1 py-6 px-3 space-y-1 overflow-y-auto custom-scrollbar pb-20">
            ...
            <NavItem active={activeTab === 'transactions'} onClick={() => setActiveTab('transactions')} icon={CreditCard} label="Transactions" />
            <NavItem active={activeTab === 'reports'} onClick={() => setActiveTab('reports')} icon={PieChart} label="Financial Analytics" />
